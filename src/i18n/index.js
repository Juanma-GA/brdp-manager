    ...
    common: {
      ...
      records: {
        ...
        assistant: {
          ...
          vocabPossiblyUnknownNames: 'This BRDP mentions names possibly not in the {{standard}} schema: {{names}}',
          ...
          vocabBlocksSuggest: 'Fix the names not found in the {{standard}} schema first',
    ...
    common: {
      ...
      records: {
        ...
        assistant: {
          ...
          vocabPossiblyUnknownNames: 'Este BRDP menciona nombres posiblemente no encontrados en el esquema de {{standard}}: {{names}}',
          ...
          vocabBlocksSuggest: 'Corrige primero los nombres no encontrados en el esquema de {{standard}}',
