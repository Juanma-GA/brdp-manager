    ...
    common: {
      ...
      config: {
        ...
        dataManagement: {
          ...
          replaceAllConfirm_one: 'Replace all BRDPs? This will permanently delete {{count}} existing BRDP and import {{importCount}} new one(s) instead. This cannot be undone.',
          replaceAllConfirm_other: 'Replace all BRDPs? This will permanently delete {{count}} existing BRDPs and import {{importCount}} new one(s) instead. This cannot be undone.',
          merge: 'Merge',
          cancel: 'Cancel',
    ...
    common: {
      ...
      config: {
        ...
        dataManagement: {
          ...
          replaceAllConfirm_one: '¿Reemplazar todos los BRDPs? Esto borrará permanentemente {{count}} BRDP existente e importará {{importCount}} nuevo(s) en su lugar. Esta acción no se puede deshacer.',
          replaceAllConfirm_other: '¿Reemplazar todos los BRDPs? Esto borrará permanentemente {{count}} BRDPs existentes e importará {{importCount}} nuevo(s) en su lugar. Esta acción no se puede deshacer.',
          merge: 'Fusionar',
          cancel: 'Cancelar',
