    ...
    common: {
      ...
      settings: {
        ...
        importEta: {
          ...
          description:
            'Controls the time estimate and confirmation thresholds shown before applying an Excel import, for every project in this installation. Based on real measurements, not a generic guess.',
          loadError: 'Could not load these settings.',
          save: 'Save',
          saving: 'Saving…',
          saved: 'Saved',
          fields: {
            msPerPlainRow: 'Estimated ms per plain row',
            msPerPlainRowHint: 'Measured baseline for rows that do not trigger an embedding call',
            msPerValidatedRow: 'Estimated ms per Validated row',
            msPerValidatedRowHint: 'Measured baseline for rows that trigger a real Mistral embedding call',
            validatedRowsThreshold: 'Validated rows threshold for confirmation',
            validatedRowsThresholdHint: 'Above this many Validated rows, Apply asks for confirmation first',
            warningSeconds: 'Estimated time threshold for confirmation (seconds)',
            warningSecondsHint: 'Above this estimated duration, Apply asks for confirmation first',
          },
        },
        trash: {
          title: 'Trash',
    ...
    common: {
      ...
      settings: {
        ...
        importEta: {
          ...
          description:
            'Controla la estimación de tiempo y los umbrales de confirmación mostrados antes de aplicar una importación de Excel, para todos los proyectos de esta instalación. Basado en mediciones reales, no en una suposición genérica.',
          loadError: 'No se pudo cargar esta configuración.',
          save: 'Guardar',
          saving: 'Guardando…',
          saved: 'Guardado',
          fields: {
            msPerPlainRow: 'ms estimados por fila normal',
            msPerPlainRowHint: 'Referencia medida para filas que no disparan una llamada de embeddings',
            msPerValidatedRow: 'ms estimados por fila Validated',
            msPerValidatedRowHint: 'Referencia medida para filas que disparan una llamada real de embeddings a Mistral',
            validatedRowsThreshold: 'Umbral de filas Validated para pedir confirmación',
            validatedRowsThresholdHint: 'Por encima de este número de filas Validated, Apply pide confirmación antes',
            warningSeconds: 'Umbral de tiempo estimado para pedir confirmación (segundos)',
            warningSecondsHint: 'Por encima de esta duración estimada, Apply pide confirmación antes',
          },
        },
        trash: {
          title: 'Papelera',
