      ...
      config: {
        ...
        dataManagement: {
          ...
          applyEtaValidatedCaveat:
            'Rows with Proposal Status "Validated" trigger a real embedding API call each and may take longer than this estimate.',
    ...
    common: {
      ...
      config: {
        ...
        dataManagement: {
          ...
          applyEtaValidatedCaveat:
            'Las filas con Proposal Status "Validated" disparan una llamada real a la API de embeddings cada una y pueden tardar más de lo estimado.',
